package by.it.group451002.hodysh.lesson12;
...
public class MyAvlMap implements Map<Integer, String> {
    ...
    public Set<Entry<Integer, String>> entrySet() {
        Set<Entry<Integer, String>> set = new java.util.HashSet<>();
        collectEntries(root, set);
        return set;
    }

    // Сбор всех пар ключ-значение (симметричный обход)
    private void collectEntries(Node n, Set<Entry<Integer, String>> set) {
        if (n != null) {
